    ...
    <>
      {error && isShowModal && (
        <Modal
          type="fail"
          title="FAILED!"
          message={`Your registration is failed because ${error}`}
          action="TRY AGAIN"
        />
      )}
      ...
      {!error && status === "completed" && isShowModal && (
        <Modal
          type="success"
          title="SUCCESS!"
          message="Your registration is successful. Let's sign in now to start wasting money on regular clothes but with a brand!"
          action="SIGN IN"
        />
      )}
      ...
      >
        <h1 className="font-bold text-5xl text-[#6F42C1] text-center mt-[35px] mb-5">
          Create Account
        </h1>
        ...
        >
          <Form className="max-w-[400px] mx-auto ">
            ...
            >
              <HiOutlineUser className="text-2xl text-[#6F42C1]" />
              <Field
                name="name"
                type="text"
            ...
            >
              <HiOutlineMail className="text-2xl text-[#6F42C1]" />
              <Field
                name="email"
                type="email"
                className={`bg-transparent flex-1 py-4 px-5 outline-none font-jakarta ${classes["input__input-effect"]}`}
            ...
            <div
              className={`bg-[#F6F5F3] flex items-center px-3 mt-3 mb-1 ${classes["input__div-effect"]}`}
            >
              <RiLockPasswordLine className="text-2xl text-[#6F42C1]" />
              <Field
                name="password"
                type="password"
                className={`bg-transparent flex-1 py-4 px-5 outline-none font-jakarta ${classes["input__input-effect"]}`}
            ...
            <button
              ...
              className="uppercase bg-[#6F42C1] text-white font-extrabold text-xl 
                ...
                active:bg-[#6F42C1] 
                hover:bg-[#ddcefb]  text-black hover:-translate-y-[2px] 
        ...
        <div className="mt-5 text-center text-gray-500 mb-7">
          ...
          <button
            className="text-[#6F42C1] hover:text-[#5a2e99] transition"

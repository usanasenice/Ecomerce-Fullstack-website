        ...
        <div className="flex items-start gap-20 mt-[70px] md:mt-5 md:flex-col">
          <div className="max-w-[600px] mt-4 md:text-center">
            ...
            >
              ...
              <p className="whitespace-nowrap">THAT ATTRACT</p>
            </p>
            <div className="!text-medium !border-l-4 !border-gray-200 !pl-5 !bg-white !leading-loose !text-lg !max-w-[500px]">
              Fashion is an art where you need to go extreme, Why be basic when you can go extreme
            </div>
            <div className="mt-9 flex items-center gap-5">
              <Link href="/men">
                <a
                  className="uppercase bg-[#b7a1e2] font-medium text-lg
                rounded-full
                active:shadow-sm active:scale-[.98] active:translate-y-0 
                active:bg-[#DDCEFB] 
                hover:bg-[#DDCEFB] hover:-translate-y-[2px] 
              ...
              <Link href="/men">
                <a className="flex gap-2 items-center">
                  <AiFillPlaySquare size={57} className="text-[#FFB6C1]" />
                  <p className="font-medium text-lg text-[#FFB6C1]">What&apos;s Trending?</p>
                </a>
              </Link>
            </div>
          </div>
      ...
      <div className="flex items-center gap-24 -mt-10 xl:mt-8 mx-auto">
        ...
        <div className="flex-grow">
          <div className="flex items-center gap-4 mb-6">
            <div className="flex items-center justify-center h-12 w-12 rounded-full bg-[#b7a1e2]">
